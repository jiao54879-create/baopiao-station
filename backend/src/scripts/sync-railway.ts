...
const products = [
  {
    ...
    advantagesPrice: JSON.stringify(['30万保额年缴4026元（30岁男性）', '终身多次赔价格最优']),
  ...
  },
  {
    ...
    advantagesPrice: JSON.stringify(['30万保额年缴5211元', '综合性价比高（考虑医疗金后）']),
  ...
  },
  {
    ...
    advantagesPrice: JSON.stringify(['性价比高，30岁男性年缴4800元起', '可选保至70岁降低保费']),
  ...
  },
  {
    ...
    advantagesPrice: JSON.stringify(['30岁男性年缴3828元（最低）', '保至70岁性价比最高', '高危职业无加费']),
  ...
  },
  {
    ...
    highlightsValue: JSON.stringify(['女性保费比男性低约6%', '30岁女性年缴3792元', '女性专属费率优势']),
    advantagesPrice: JSON.stringify(['30岁女性年缴3792元（女性最低）', '30岁男性年缴4062元', '女性保费优惠显著']),
