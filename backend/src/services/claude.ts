...
export const STYLE_DEFINITIONS: Record<StyleType, StyleDefinition> = {
  ...
  D: {
    ...
    exampleTitles: ['和儿科医生聊完，我把宝宝的保险全部换掉了','律师朋友看完我的保单，只说了一句话（太扎心）','陪客户理赔50万后，我总结出普通人买保险的真相','和精算师深聊后，发现我以前买保险全错了','看完天涯老哥的万字保险帖，我直接退了3份保单'],
    templates: ['和[权威人士]聊完，我把[保险方案]换了','[权威人士]看完我的保单，说了一句[悬念]','陪客户理赔[X]万后，我总结出...','看完体检报告，我立刻给自己加保了','看完天涯老哥的[万字/半年]保险帖，我直接[动作]']
  },
  E: {
