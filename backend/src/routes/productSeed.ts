...
const products: ProductSeed[] = [
  // ==================== 成人重疾险 ====================
  {
    ...
    highlightsSpecial: [
      ...
      { category: '可选-同种重疾多次', title: '同种重疾也可赔150%', value: '复发/转移/新发均适用' },
    ...
    advantages: [
      ...
      { dimension: '价格', content: '40万保额年缴6948，性价比优于同档竞品', weight: 'medium' }
    ],
    competitors: [
      {
        productName: '达尔文12号',
        dimensions: [
          { name: '年缴保费(30岁/30万/30年)', thisProduct: '约¥5,220', competitor: '约¥4,026', winner: 'competitor' },
    ...
    competitors: [
      {
        productName: '超级玛丽16号',
        dimensions: [
          { name: '年缴保费(30岁/30万/30年)', thisProduct: '约¥4,026', competitor: '约¥5,220', winner: 'this' },
    ...
    competitors: [
      {
        ...
        dimensions: [
          { name: '0岁男宝30万30年保终身年缴', thisProduct: '约¥3,510', competitor: '¥3,025', winner: 'competitor' },
      ...
      },
      {
        ...
        dimensions: [
          { name: '0岁男宝30万30年保终身年缴', thisProduct: '约¥3,510', competitor: '¥3,145', winner: 'competitor' },
    ...
    competitors: [
      {
        productName: '青云卫6号',
        dimensions: [
          { name: '0岁男宝30万30年保终身年缴', thisProduct: '¥3,025', competitor: '约¥3,510', winner: 'this' },
...

  {
    ...
    highlightsValue: [
      { category: '保障至85岁', title: '保障期限灵活', value: '可选至30年/70岁/终身/85岁' }
    ],
    advantages: [
    ...
    competitors: [
      ...
      },
      {
        productName: '青云卫6号',
        dimensions: [
          { name: '0岁男宝30万30年保终身年缴', thisProduct: '¥3,145', competitor: '约¥3,510', winner: 'this' },
    ...
    notes: '大黄蜂系列第17代全能版，北京人寿承保，2026年4月22日上线，新增重疾持续增长金和特定住院津贴是核心升级'
  },
  ...
  // ==================== 医疗险 ====================
  {
    ...
    highlightsWaiver: [],
    highlightsSpecial: [
      { category: '特药保障', title: '院外特药', value: '包含162种特药，100%报销' },
    ...
    advantages: [
      ...
      { dimension: '特药', content: '特药保障全面', weight: 'medium' }
    ],
    competitors: [
      {
        ...
        dimensions: [
          ...
          { name: '年缴保费(30岁)', thisProduct: '¥247', competitor: '¥262', winner: 'this' },
  ...
  // ==================== 定期寿险 ====================
  {
    ...
    highlightsSpecial: [
      ...
      { category: '最高保额', title: '最高保额', value: '400万' },
